...
namespace LibraryDbFirstApproach.Controllers
{
    public class BooksController : Controller
    {
        private readonly LibraryMvcdbContext _context;

        public BooksController(LibraryMvcdbContext context)
        {
            _context = context;
        }
        ...
        {
            var libraryMvcdbContext = _context.Books.Include(b => b.Author);
            return View(await libraryMvcdbContext.ToListAsync());
        }
